...
Description: Wtyczka służy do tworzenia Pop Upów  - wyskakujących okienek do zapisu na listę za pomoacą shortcodu
Version: 1.6
...
function github_plugin_updater_test_init() {
	include_once 'plugins_url( 'updater.php, __FILE__ )';
